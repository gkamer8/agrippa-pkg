...
from agrippa.onnx2torch.node_converters import get_converter
from agrippa.onnx2torch.onnx_graph import OnnxGraph
from agrippa.onnx2torch.onnx_graph import ValueType
from agrippa.onnx2torch.utils.safe_shape_inference import safe_shape_inference
...
def convert(  # pylint: disable=too-many-locals, too-many-branches, too-many-statements
    ...
    The registered operation can be found in agrippa.onnx2torch/node_converters.

    Usage example:

        from agrippa.onnx2torch import convert
